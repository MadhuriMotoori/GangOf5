...
/**
 * Write a description of class GhostAbstract here.
 * 
 * @author (your name) 
...
public abstract class GhostAbstract extends Actor
{
    ...
    protected int exitCounter=0;
    protected int moveCounter=0;
    protected int dangerCounter=0;
    protected int setImage=1;
    ...
    protected Player getPlayerDeath()
    {
    ...
    protected int playerGetPosition(int player, String axis)
    {
        int position=0;
        if(player==1) {
            for (Object obj : getWorld().getObjects(Player.class)) {
